...
<body>
    ...
    <a href="Login.html"><img src="Imagem/logout.png" class="imgl" alt="Imagem Logout" width="70px" border-radius="50px"></a>
    <br>
    ...
    <a href="Agendamento.html"><img src="Imagem/agendamento.png" class="imgagendamento" alt="Imagem Agendamento" width="100px" border-radius="50px"></a>
    <br>
