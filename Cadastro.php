...
<body>
    <img class="imgsec" src="Imagem/medi.jpg" class="rounded float-left" alt="Imagem Medicina." width="500px">
    <img class="imgsec" src="Imagem/medicina.jpg" class="rounded float-left" alt="Imagem Medicina1." width="500px">
